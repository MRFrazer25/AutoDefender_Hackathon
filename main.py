    ...
    if export_path:
        try:
            ...
            if export_format.lower() == 'csv':
                success = exporter.export_threats_csv(filtered_threats, export_path)
            else:
                success = exporter.export_threats_json(filtered_threats, export_path)
            
            if success:
                console.print(f"[green][OK][/green] Exported {len(filtered_threats)} threats to {export_path}")
            else:
